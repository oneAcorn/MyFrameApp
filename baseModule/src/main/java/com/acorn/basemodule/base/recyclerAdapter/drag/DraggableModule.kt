package com.acorn.basemodule.base.recyclerAdapter.drag
...
import com.acorn.basemodule.base.recyclerAdapter.drag.listener.DraggableListenerImp
import com.acorn.basemodule.base.recyclerAdapter.drag.listener.OnItemDragListener
import com.acorn.basemodule.base.recyclerAdapter.drag.listener.OnItemSwipeListener
import java.util.*
...
interface DraggableModule {
     ...
     */
    fun addDraggableModule(baseQuickAdapter: BaseRecyclerAdapter<*, *>): BaseDraggableModule {
        return BaseDraggableModule(baseQuickAdapter)
    }
}

open class BaseDraggableModule(private val baseQuickAdapter: BaseRecyclerAdapter<*, *>) :
