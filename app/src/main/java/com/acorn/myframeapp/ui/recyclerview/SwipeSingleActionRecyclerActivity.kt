...
import com.acorn.myframeapp.ui.recyclerview.adapter.SwipeSingleActionRecyclerAdapter
 ...
 */
class SwipeSingleActionRecyclerActivity : BaseNoViewModelActivity() {
    private var mAdapter: SwipeSingleActionRecyclerAdapter? = null
    ...
    override fun initView() {
        ...
        mAdapter = SwipeSingleActionRecyclerAdapter(this, getRandomList())
        rv.adapter = mAdapter
    ...
    private fun getSwipeAction(): QMUIRVItemSwipeAction {
        return QMUIRVItemSwipeAction(true, object : QMUIRVItemSwipeAction.Callback() {
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                showTip("直接滑动删除:${viewHolder.adapterPosition}")
